...
public class RequesterHttpImpl implements Requester{
	 ...
	 * When calling executeRequest, this.request must be non null or there will be a null pointer exception
	 */
	...
	public String executeRequest() throws NullPointerException{
		...
		try {
			...
			if (responseCode == 200) {
				...
				Log.e(this.toString(), String.format("Http code %d", responseCode));
			}
			//release resources
